--- For more information regarding configuration -- refer to (https://github.com/dnelyk/qb-bankrobbery-target/blob/main/README.md) and go to the configuration tab.

Config = Config or {}

--- Wait time for vault opening
Config.WaitTime = 300000 -- 5 Minutes (refer https://www.inchcalculator.com/convert/millisecond-to-second/ to customize times)

-- Two Hacks --
Config.TwoHack = false -- This is a feature to enable a certain chance (20%) of an easier hack (mhacking) instead of the laptop themed hack. Disabled by default.

--This is the amount of time it takes for the cops to be called for the coorosponding bank robbery.
Config.CopCallTime = 30000 -- 30 Seconds (refer https://www.inchcalculator.com/convert/millisecond-to-second/ to customize times) 

Config.Stress = true -- Enables/Disables stress when grabbing money.

Config.StressAmount = 15 -- Enables/Disables stress when grabbing money.

Config.FleecaItem = "markedbills" -- MUST BE INSIDE OF QUOTES example: "youritemname" - This is the item the player recieves when grabbing money from the tray, They are awarded 201-294 of these.

Config.RandomItemAmount = math.random(5, 9) -- Default: Gives 5 to 9 items. Change only the two numbers if you wish to change the amount. Keep the given format, or issues may happen.

----- These are not used, ignore them ----

-- Config.PaletoItem = "markedbills" -- These are not used in the current version of qb-bankrobbery-target
-- Config.PacificItem = "markedbills"  -- These are not used in the current version of qb-bankrobbery-target

------------------------------------------

Config.ItemTiers = 1

--- Minimum Police (-1 = No Minimum)
Config.MinimumPaletoPolice = -1
Config.MinimumPacificPolice = -1
Config.MinimumFleecaPolice = -1
Config.MinimumThermitePolice = -1

--- Types of Different Rewards
Config.RewardTypes = {
    [1] = {
        type = "item"
    },
...
--- Different Rewards from lockers (Unused in this script)
Config.LockerRewards = { -- Fleeca
    ["tier1"] = {
        [1] = {item = "markedmoney", minAmount = 5, maxAmount = 15},
    },
    ["tier2"] = {
        [1] = {item = "markedmoney", minAmount = 5, maxAmount = 15},
    },
    ["tier3"] = {
        [1] = {item = "markedmoney", minAmount = 1, maxAmount = 1},
    },
}

Config.LockerRewardsPaleto = {
    ["tier1"] = {
        [1] = {item = "markedmoney", minAmount = 10, maxAmount = 20},
    },
    ["tier2"] = {
        [1] = {item = "markedmoney", minAmount = 10, maxAmount = 20},
    },
    ["tier3"] = {
        [1] = {item = "markedmoney", minAmount = 2, maxAmount = 4},
    },
}
